 ...
 */
exports.splitArray = exports._SPLIT_ARRAY = function (
  arr = [],
  chunk_size = 25
) {
...
Object.assign(
  exports,
  require(path.join(__dirname, "api_response_formatter.es6"))
);
...
Object.assign(
  exports,
  require(path.join(__dirname, "get_http_request_params.es6"))
);

//@ Check if the specified properties are defined in an object
Object.assign(
  exports,
  require(path.join(__dirname, "is_object_parameter_defined.es6"))
);

//@ Check if the specified properties are present in an object
Object.assign(
  exports,
  require(path.join(__dirname, "is_object_parameter_present.es6"))
);
...
Object.assign(
  exports,
  require(path.join(__dirname, "object_property_structure_verifier.es6"))
);
